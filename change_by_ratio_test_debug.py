...
def test_main(cate_num, adv_num, change_ratio, search_mode, start_time):
...
if __name__ == "__main__":
    ...
    assert((change_ratio > 0) and (change_ratio <= 1))
    test_main(cate_num, adv_num, change_ratio, search_mode, start_time)