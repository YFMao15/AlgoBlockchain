...
def test_main(cate_num, adv_num, key, change_ratio, search_mode, start_time):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-p', '--percentage', type=float,
        help='The changing ratio of the advertisers')
    ...
    for _ in range(round_num):
        test_main(cate_num, adv_num, key, percentage, search_mode, start_time)
        time.sleep(5)