...
def test_main(cate_num, key):
    ...
    for idx in range(1, cate_num + 1):
        ...
        local_hash_time = 0.
        hash_search_time = 0.
        print("Testing searching capability of smart contract on " + str(idx) + " categories...\n")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Running the search testing on multiple categories of blockchain in cmd mode.')
